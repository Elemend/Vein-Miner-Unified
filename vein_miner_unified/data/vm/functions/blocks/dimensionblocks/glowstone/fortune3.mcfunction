...
scoreboard players operation #vm_fortrand vm_calc %= #vm_9 vm_calc
execute if score #vm_fortrand vm_calc matches 0 run scoreboard players add @s vm_pickus 2
execute if score #vm_fortrand vm_calc matches 1..8 run scoreboard players add @s vm_pickus 3
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/dimensionblocks/glowstone/fortune3