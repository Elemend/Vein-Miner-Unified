...
scoreboard players operation #vm_fortrand vm_calc %= #vm_2 vm_calc
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/oceans/sea_lantern/sea1