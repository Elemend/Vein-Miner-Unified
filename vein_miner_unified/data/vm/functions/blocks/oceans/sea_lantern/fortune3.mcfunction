...
execute if score #vm_fortrand vm_calc matches 3..4 run scoreboard players add @s vm_pickus 4

execute if score @s vm_calc >= #vm_cycle vm_pickus run function vm:blocks/oceans/sea_lantern/crystalitems
execute if score @s vm_calc >= #vm_cycle vm_pickus run scoreboard players set #vm_frstop vm_calc 0
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/oceans/sea_lantern/fortune3