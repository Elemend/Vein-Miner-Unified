...
execute if score #vm_fortrand vm_calc matches 5..6 run scoreboard players add @s vm_pickus 8
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/crops/melon/fortune3