...
execute if score #vm_fortrand vm_calc matches 1 run scoreboard players add @s vm_pickus 1
execute if score #vm_fortrand vm_calc matches 2 run scoreboard players add @s vm_pickus 2
execute if score #vm_fortrand vm_calc matches 3 run scoreboard players add @s vm_pickus 3
execute if score #vm_fortrand vm_calc matches 4 run scoreboard players add @s vm_pickus 4
execute if score #vm_fortrand vm_calc matches 5 run scoreboard players add @s vm_pickus 5
execute if score #vm_fortrand vm_calc matches 6 run scoreboard players add @s vm_pickus 6
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/crops/carrots/fortune3