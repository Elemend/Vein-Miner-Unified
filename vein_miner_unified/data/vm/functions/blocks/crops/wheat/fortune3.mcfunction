...
execute if score #vm_fortrand vm_calc matches 4 run scoreboard players add #vm_max vm_pickus 4
execute if score #vm_fortrand vm_calc matches 5 run scoreboard players add #vm_max vm_pickus 5
execute if score #vm_fortrand vm_calc matches 6 run scoreboard players add #vm_max vm_pickus 6

execute if score @s vm_calc >= #vm_cycle vm_pickus run function vm:blocks/crops/wheat/nitems
execute if score @s vm_calc >= #vm_cycle vm_pickus run scoreboard players set #vm_frstop vm_calc 0
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/crops/wheat/fortune3