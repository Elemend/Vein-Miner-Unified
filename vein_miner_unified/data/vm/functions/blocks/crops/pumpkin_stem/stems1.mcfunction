...
scoreboard players operation #vm_fortrand vm_calc %= #vm_125 vm_calc
execute if score #vm_fortrand vm_calc matches 0..19 run scoreboard players add @s vm_pickus 1
execute if score #vm_fortrand vm_calc matches 20..23 run scoreboard players add @s vm_pickus 2
execute if score #vm_fortrand vm_calc matches 24 run scoreboard players add @s vm_pickus 3

execute if score @s vm_calc >= #vm_cycle vm_pickus run function vm:blocks/crops/pumpkin_stem/nitems
execute if score @s vm_calc >= #vm_cycle vm_pickus run scoreboard players set #vm_frstop vm_calc 0
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/crops/pumpkin_stem/stems1