...
execute if score @s vm_calc >= #vm_cycle vm_pickus run function vm:blocks/crops/melon_stem/nitems
execute if score @s vm_calc >= #vm_cycle vm_pickus run scoreboard players set #vm_frstop vm_calc 0
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/crops/melon_stem/stems1