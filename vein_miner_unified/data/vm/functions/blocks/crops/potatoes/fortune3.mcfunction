...
scoreboard players operation #vm_potrand vm_calc %= #vm_7 vm_calc
...
execute if score #vm_potrand vm_calc matches 4 run scoreboard players add @s vm_pickus 4
execute if score #vm_potrand vm_calc matches 5 run scoreboard players add @s vm_pickus 5
execute if score #vm_potrand vm_calc matches 6 run scoreboard players add @s vm_pickus 6
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/crops/potatoes/fortune3