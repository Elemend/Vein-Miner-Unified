...
scoreboard players operation #vm_potrand vm_calc %= #vm_5 vm_calc
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/crops/potatoes/fortune1