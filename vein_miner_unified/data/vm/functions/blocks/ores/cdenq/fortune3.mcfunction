...
execute if score #vm_fortrand vm_calc matches 3 run scoreboard players add @s vm_pickus 2
execute if score #vm_fortrand vm_calc matches 4 run scoreboard players add @s vm_pickus 3
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/ores/cdenq/fortune3