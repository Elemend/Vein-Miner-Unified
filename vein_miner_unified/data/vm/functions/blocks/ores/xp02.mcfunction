...
scoreboard players operation #vm_xprand vm_calc %= #vm_3 vm_calc
execute if score #vm_xprand vm_calc matches 1 run scoreboard players add #vm_orexp vm_calc 1
execute if score #vm_xprand vm_calc matches 2 run scoreboard players add #vm_orexp vm_calc 2
...
execute if score #vm_orexp vm_pickus < #vm_cycle vm_pickus run function vm:blocks/ores/xp02