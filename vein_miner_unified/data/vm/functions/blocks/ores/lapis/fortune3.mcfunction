...
scoreboard players operation #vm_fortrand vm_calc %= #vm_25 vm_calc
...
execute if score #vm_fortrand vm_calc matches 12..13 run scoreboard players add @s vm_pickus 11
execute if score #vm_fortrand vm_calc matches 14 run scoreboard players add @s vm_pickus 13
execute if score #vm_fortrand vm_calc matches 15 run scoreboard players add @s vm_pickus 14
execute if score #vm_fortrand vm_calc matches 16..17 run scoreboard players add @s vm_pickus 15
execute if score #vm_fortrand vm_calc matches 18 run scoreboard players add @s vm_pickus 17
execute if score #vm_fortrand vm_calc matches 19 run scoreboard players add @s vm_pickus 19
execute if score #vm_fortrand vm_calc matches 20 run scoreboard players add @s vm_pickus 20
execute if score #vm_fortrand vm_calc matches 21..22 run scoreboard players add @s vm_pickus 23
execute if score #vm_fortrand vm_calc matches 23 run scoreboard players add @s vm_pickus 27
execute if score #vm_fortrand vm_calc matches 24 run scoreboard players add @s vm_pickus 31
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/ores/lapis/fortune3