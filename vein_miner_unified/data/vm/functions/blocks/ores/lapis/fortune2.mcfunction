...
scoreboard players operation #vm_fortrand vm_calc %= #vm_20 vm_calc
...
execute if score #vm_fortrand vm_calc matches 16 run scoreboard players add @s vm_pickus 15
execute if score #vm_fortrand vm_calc matches 17 run scoreboard players add @s vm_pickus 17
execute if score #vm_fortrand vm_calc matches 18 run scoreboard players add @s vm_pickus 20
execute if score #vm_fortrand vm_calc matches 19 run scoreboard players add @s vm_pickus 23
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/ores/lapis/fortune2