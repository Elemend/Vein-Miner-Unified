...
execute if score #vm_fortrand vm_calc matches 1..2 run scoreboard players add @s vm_pickus 4
execute if score #vm_fortrand vm_calc matches 3..4 run scoreboard players add @s vm_pickus 5
execute if score #vm_fortrand vm_calc matches 5..6 run scoreboard players add @s vm_pickus 6
execute if score #vm_fortrand vm_calc matches 7 run scoreboard players add @s vm_pickus 7
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/ores/redstone/fortune3