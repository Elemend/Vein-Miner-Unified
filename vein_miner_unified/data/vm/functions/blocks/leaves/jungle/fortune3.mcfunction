...
execute if score #vm_sap vm_calc matches 0..417 run scoreboard players add @s vm_pickus 1
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/leaves/jungle/fortune3