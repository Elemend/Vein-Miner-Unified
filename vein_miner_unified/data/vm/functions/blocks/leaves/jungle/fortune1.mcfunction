...
scoreboard players operation #vm_sap vm_calc %= #vm_10000 vm_calc
execute if score #vm_sap vm_calc matches 0..278 run scoreboard players add @s vm_pickus 1
...
scoreboard players operation #vm_stk vm_calc %= #vm_90 vm_calc
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/leaves/jungle/fortune1