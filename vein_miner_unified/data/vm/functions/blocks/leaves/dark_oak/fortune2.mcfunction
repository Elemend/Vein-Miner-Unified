...
execute if score #vm_apl vm_calc matches 0..625 run scoreboard players add #vm_max vm_pickus 1
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/leaves/dark_oak/fortune2