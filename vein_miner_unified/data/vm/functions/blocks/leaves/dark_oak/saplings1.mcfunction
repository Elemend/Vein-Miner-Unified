...
function vm:blocks/leaves/drops
...
scoreboard players operation #vm_apl vm_calc %= #vm_200 vm_calc
execute if score #vm_apl vm_calc matches 0 run scoreboard players add #vm_max vm_pickus 1

execute if score @s vm_calc >= #vm_cycle vm_pickus run function vm:blocks/leaves/dark_oak/sapitems
execute if score @s vm_calc >= #vm_cycle vm_pickus run scoreboard players set #vm_frstop vm_calc 0
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/leaves/dark_oak/saplings1