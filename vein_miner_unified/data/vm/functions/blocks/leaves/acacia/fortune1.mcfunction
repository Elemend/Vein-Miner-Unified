...
execute if score @s vm_calc >= #vm_cycle vm_pickus run function vm:blocks/leaves/acacia/sapitems
execute if score @s vm_calc >= #vm_cycle vm_pickus run scoreboard players set #vm_frstop vm_calc 0
execute if score @s vm_calc < #vm_cycle vm_pickus run function vm:blocks/leaves/acacia/fortune1