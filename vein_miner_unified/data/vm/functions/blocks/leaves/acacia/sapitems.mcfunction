execute if score @s vm_pickus matches 65.. run summon item ~ ~ ~ {Item:{id:"minecraft:acacia_sapling",Count:64b},Tags:["vm_item"]}
execute if score @s vm_pickus matches 65.. run scoreboard players remove @s vm_pickus 64
execute if score @s vm_pickus matches 1..64 run summon item ~ ~ ~ {Item:{id:"minecraft:acacia_sapling",Count:1b},Tags:["vm_adjust","vm_item"]}
...
execute if score @s vm_pickus matches 65.. run function vm:blocks/leaves/acacia/sapitems